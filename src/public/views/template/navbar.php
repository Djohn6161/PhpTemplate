    ...
    <div class="main-navbar">
      ...
      <div id="mainnav">
        <ul class="nav-menu custom-scrollbar">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title link-nav <?= $active == "home" ? "active" : "" ?>" href="<?= $this->basePath ?>home"><i data-feather="home"></i><span>Dashboard</span></a>
          </li>
          <!-- <li class="dropdown">
                    <a
          ...
          ?>
            <li class="dropdown">
              <a class="nav-link menu-title <?= $active == "result" || ($active == "kpi" || $active == "evaluation" || $active == "result") ? "active" : "" ?>" href="javascript:void(0)"><i data-feather="settings"></i><span>Management</span></a>
          ...
          ?>
            <li class="dropdown">
              <a
                ...
                href="<?= $this->basePath ?>schedule/assessment"><i data-feather="calendar"></i><span>Quarterly Schedule</span></a>
            </li>
          <?php
          }
          ?>
